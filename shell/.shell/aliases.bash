...
alias gbdm='git branch --merged | grep -i -v -E "master|dev"| xargs git branch -d'
...
## applications
alias chrome:dev="/Applications/Google\ Chrome.app/Contents/MacOS/Google\ Chrome --auto-open-devtools-for-tabs"
